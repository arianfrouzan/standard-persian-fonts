export default [
    ...
    },
    {
        nameFa: 'فربد',
        nameEn: 'Farbod',
        url: 'https://github.com/font-store/FarbodFont',
        type: 'serif',
        weights: ['normal']
    },
    {
    ...
    },
    {
        nameFa: 'نیکا',
        nameEn: 'Nika',
        url: 'https://github.com/font-store/font-Nika',
        type: 'serif',
        weights: ['normal']
    },
    {
        nameFa: 'نون',
        nameEn: 'Noon',
        url: 'https://github.com/font-store/font-Noon',
        type: 'serif',
        weights: ['normal']
    },
    {
    ...
    },
    {
        nameFa: 'یکان',
        nameEn: 'Yekan',
        url: 'https://github.com/font-store/font-Yekan',
        type: 'sans-serif',
        weights: ['normal', 'bold']
    }
]